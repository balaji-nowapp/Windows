...
namespace Pidilite
{
    ...
    public static class RegistryConfig
    {
        ...
        public static PrivateFontCollection pfc1 = new PrivateFontCollection();
        ...
        static RegistryConfig ()
            ...
            try
            {
                ...
                uint dummy1 = 0;
                pfc1.AddMemoryFont(fontPtr1, Properties.Resources.OpenSans_Bold.Length);
                ...
                myFontBold = new Font(pfc1.Families[1],8.0F);
                myBCFont = new Font(pfc1.Families[1], 12.0F);
            }
            catch (Exception ex)
            {
